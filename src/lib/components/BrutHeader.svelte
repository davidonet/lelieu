...
<header class="sticky top-0 z-40 bg-brut-paper border-b-[3px] border-brut-ink">
	<div class="mx-auto max-w-6xl px-4 sm:px-6 py-3 flex items-center justify-between gap-4">
		<a href="/" class="flex items-center gap-3 group" aria-label="LE LIEU — accueil">
			<img
				src={logotype}
				alt="LE LIEU"
				...
				height="414"
			/>
			<span class="hidden sm:inline font-mono text-[10px] uppercase tracking-widest text-brut-petrol">
					...
					<li class="border-b-[3px] border-brut-ink last:border-b-0">
						<a
							...
							class={cn(
								...
								isActive(item.href) ? 'bg-brut-ink text-brut-paper' : 'bg-brut-paper text-brut-ink'
							)}
						>
							{item.label}
						</a>
