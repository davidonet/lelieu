...
partner:
  name: Espace Agapé
  url: https://www.espace-agape.com
features:
  - Table de massage et matelas au sol
  - Lumière douce, chauffage indépendant
  - Huiles végétales et linge propre fournis
  - Coin vestiaire et lavabo
...
- **Massage prénatal** pour les grossesses.
- **Massage des extrémités** (pieds, mains, crâne) — séance courte, effet long.
- **Massage adapté** pour les personnes âgées ou en situation de handicap.
- **Ateliers d'initiation** — apprendre à toucher, à plusieurs.

## L'argent ne doit pas être une limite

Espace Agapé tient à ce principe et nous le partageons. Les tarifs sont discutés, plusieurs formules existent, et la première rencontre peut se faire sans engagement. Écrivez — on trouve.
