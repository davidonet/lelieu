...
<section class="relative border-brut-ink overflow-hidden">
  ...
  <div class="mx-auto max-w-6xl px-4 sm:px-6 pt-14 pb-20 sm:pt-20 sm:pb-28">
    ...
    <p
      class="mt-8 font-mono uppercase tracking-widest text-xs sm:text-sm text-brut-petrol"
    >
      {tagline}
    </p>
    ...
    <div class="mt-10 grid gap-8 md:grid-cols-[1.4fr_1fr] items-start">
      ...
      <BrutCard color="petrol" class="md:translate-y-6">
        <h2 class="font-display text-2xl uppercase mb-3">
          Six espaces, un même toit
        </h2>
        <ul class="font-mono text-sm space-y-2">
          <li>01 — Une micro-galerie</li>
          <li>02 — Un atelier d'art</li>
          <li>03 — Un fablab</li>
          <li>04 — Un espace massage</li>
          <li>05 — Une cuisine partagée</li>
          <li>06 — Un futur studio son</li>
        </ul>
        <div class="mt-6 flex flex-wrap gap-3">
          <BrutButton href="#espaces" variant="accent"
            >Voir les espaces</BrutButton
          >
  ...
  <div class="mx-auto max-w-6xl px-4 sm:px-6 pb-20">
    <div class="grid gap-6 md:grid-cols-3">
      <BrutCard color="yellow">
        <p class="font-mono text-[11px] uppercase tracking-widest mb-3">
          Rêver
        </p>
        ...
        <p class="text-sm leading-relaxed">
          On commence par dire ce qu'on aimerait voir arriver. Les murs viennent
          après.
        </p>
      </BrutCard>
      <BrutCard color="orange">
        ...
        <p class="text-sm leading-relaxed">
          Chaque pratique partagée fabrique un peu de la culture du lieu — et de
          celle qui en sort.
        </p>
      </BrutCard>
      <BrutCard color="red">
        ...
        <p class="text-sm leading-relaxed">
          Un atelier, une exposition, un concert : autant d'occasions d'être
          pleinement là.
        </p>
      </BrutCard>
    </div>
...
<section id="actualites" class="bg-brut-paper border-t-[3px] border-brut-ink">
  <div class="mx-auto max-w-6xl px-4 sm:px-6 py-16 sm:py-20">
    <div class="flex items-end justify-between flex-wrap gap-4 mb-10">
      <div>
        <p
          class="font-mono text-xs uppercase tracking-widest text-brut-petrol mb-2"
        >
          Actualités & événements
        </p>
        <h2 class="font-display text-4xl sm:text-5xl uppercase">
          {news.title}
        </h2>
      </div>
      <p
        class="font-mono text-xs uppercase tracking-widest text-brut-petrol max-w-[40ch]"
      >
        {news.intro}
      </p>
    </div>
  ...
  <div class="mx-auto max-w-6xl px-4 sm:px-6 py-16 sm:py-20">
    <div class="flex items-end justify-between flex-wrap gap-4 mb-10">
      ...
      <p
        class="font-mono text-xs uppercase tracking-widest text-brut-petrol max-w-[40ch]"
      >
        Six pratiques côte à côte — chacune avec sa couleur, ses outils, son
        rythme.
      </p>
    </div>
